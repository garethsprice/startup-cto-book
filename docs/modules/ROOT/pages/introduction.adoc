:page-description: No standard training exists for the startup CTO role. This introduction maps the gap between what engineers prepare for and what the job demands.
:page-llms-description: Introduction to the startup CTO role — why no standard training exists, the gap between what engineers prepare for and what the job demands, and what this book covers.
:page-haiku: Five days, five crises. / No one told you this was the / job you signed up for.
:description: No standard training exists for the startup CTO role. This introduction maps the gap between what engineers prepare for and what the job demands.
:keywords: startup CTO, CTO role, engineering leadership, first-time CTO, technology management
...
*Part I — The Map* (Chapters 1–3) orients you. xref:1-four-stages-cto-evolution.adoc[Chapter 1] establishes the four-stage framework. xref:2-how-people-become-ctos.adoc[Chapter 2] normalises the "accidental CTO" experience — the fact that almost nobody who holds this title was ready for it. xref:3-ceo-cto-relationship.adoc[Chapter 3] addresses the CEO-CTO relationship, the single most consequential dynamic in the startup. Read Part I first regardless of your stage. It takes less than an hour and reframes everything that follows.

*Part II — Building and Shipping* (Chapters 4–9) is the operational playbook. Technical decisions as business decisions (xref:4-technical-decisions-business-decisions.adoc[Chapter 4]). Technical debt as a strategic instrument (xref:5-technical-debt.adoc[Chapter 5]). Shipping velocity as competitive advantage (xref:6-shipping-software.adoc[Chapter 6]). Managing the pressure to move faster (xref:7-rushing-vs-speed.adoc[Chapter 7]). Working with product (xref:8-working-with-product.adoc[Chapter 8]). Measuring what matters (xref:9-measuring-engineering-metrics.adoc[Chapter 9]). This is the section you will dog-ear and return to. If you are in Stage 1 or early Stage 2, start here after Part I.

*Part III — The Gap Nobody Talks About* (Chapters 10–12) delivers the book’s core insight. xref:10-business-acumen-gap.adoc[Chapter 10] argues that the business acumen gap — not technical skill — is what gets CTOs fired. xref:11-building-engineering-team.adoc[Chapter 11] covers building and leading the team. xref:12-ai-transformation.adoc[Chapter 12] addresses the AI transformation and what it means for the CTO’s role. If you are in Stage 2 or 3 and feel the ground shifting beneath you, this is where the book becomes different from every other engineering leadership book you have read.

*Part IV — Surviving and Evolving* (Chapters 13–17) addresses the personal and existential dimensions. The identity crisis of leaving code behind (xref:13-maker-to-multiplier.adoc[Chapter 13]). The operating rhythm that keeps you sane (xref:14-operating-rhythm.adoc[Chapter 14]). The loneliness and burnout that the role produces (xref:15-cto-burnout-isolation.adoc[Chapter 15]). Knowing when to step aside (xref:16-knowing-when-to-step-aside.adoc[Chapter 16]). Building something that outlasts you (xref:17-building-lasting-legacy.adoc[Chapter 17]). If you are in Stage 3 or 4 — or if you are at any stage and feeling the weight of the role — read Part IV. It contains the content you did not know you needed.
