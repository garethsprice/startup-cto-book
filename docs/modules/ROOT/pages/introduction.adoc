...
*Part II — Building and Shipping* (Chapters 4–8) is the operational playbook. Technical decisions as business decisions (Chapter 4). Technical debt as a strategic instrument (Chapter 5). Shipping velocity as competitive advantage (Chapter 6). Managing the pressure to move faster (Chapter 7). Measuring what matters (Chapter 8). This is the section you will dog-ear and return to. If you are in Stage 1 or early Stage 2, start here after Part I.

*Part III — The Gap Nobody Talks About* (Chapters 9–11) delivers the book’s core insight. Chapter 9 argues that the business acumen gap — not technical skill — is what gets CTOs fired. Chapter 10 covers building and leading the team. Chapter 11 addresses the AI transformation and what it means for the CTO’s role. If you are in Stage 2 or 3 and feel the ground shifting beneath you, this is where the book becomes different from every other engineering leadership book you have read.

*Part IV — Surviving and Evolving* (Chapters 12–15) addresses the personal and existential dimensions. The identity crisis of leaving code behind (Chapter 12). The loneliness and burnout that the role produces (Chapter 13). Knowing when to step aside (Chapter 14). Building something that outlasts you (Chapter 15). If you are in Stage 3 or 4 — or if you are at any stage and feeling the weight of the role — read Part IV. It contains the content you did not know you needed.
