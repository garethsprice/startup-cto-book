:page-aliases: appendix-e.adoc
:page-description: Quick-reference tables for daily, weekly, monthly, and quarterly operating rhythms — the practical companion to Chapter 14.
:page-llms-description: Quick-reference tables for daily, weekly, monthly, and quarterly CTO operating rhythms with stage markers and delegation triggers.
:page-haiku: Steady rhythms hold / what scattered urgency drops. / Structure sets you free.
:description: Quick-reference tables for daily, weekly, monthly, and quarterly operating rhythms — the practical companion to Chapter 14.
:keywords: operating rhythm, daily standup, weekly sync, quarterly planning, CTO schedule
:page-date-published: 2026-03-11
:page-date-modified: 2026-03-11
= Appendix E: The Operating Rhythm -- Quick Reference

This appendix is the tool. xref:14-operating-rhythm.adoc[Chapter 14] provides the argument.
...
What to automate, what to assist, what to protect. See xref:14-operating-rhythm.adoc[Chapter 14] for the argument.

[cols="1,2,3,2",options="header"]
|===
| Category | Fully Automatable | AI-Assisted (human decides) | Human-Only

| **Daily**
| Deep work block defence, shutdown ritual, notification management
| Morning launch (AI briefs, you prioritise), CEO check-in prep, triage and capture
| --

| **Weekly**
| 5-15 update drafting
| 1:1 prep, spec review, incident summary, pipeline analytics, weekly review scoring
| 1:1 conversations themselves

| **Monthly**
| Budget variance analysis
| Tech debt quantification, skip-level prep, all-hands content drafting
| Team health (no surveillance), advisory conversation

| **Quarterly**
| OKR auto-scoring (quantitative)
| Architecture dependency mapping, competitive intelligence, board deck first draft
| Strategy decisions, energy audit

| **Annual**
| Benchmark data assembly
| Roadmap research, budget scenario modelling
| Succession planning, career conversations, organisational judgment

|===

**The principle:** automate the assembly, assist the analysis, protect the relationships.

**Starter stack (minimal, low-maintenance):** Meeting summariser (Granola or Fireflies) + email filter (SaneBox or Superhuman) + calendar defence (Reclaim.ai) + AI assistant (Claude Projects) + one automation workflow for the shutdown ritual (n8n or Zapier). Commit for 90 days before changing anything.

**The ADHD-specific rule:** prefer tools that run without being asked. SaneBox filters silently. Reclaim defends blocks automatically. The n8n shutdown workflow fires on schedule. If a tool requires daily engagement to maintain, it will be abandoned within two weeks.


== The Seven Things You Never Delegate

Regardless of stage, team size, or how good your VPE is, these stay with you:

. The CEO relationship and daily/weekly alignment
. Technology vision and long-term strategy
. Board-level technical communication
. Senior executive hiring decisions
. Engineering culture and values
. The advisory conversation (your external support)
. The shutdown ritual (your internal support)

Delegate everything else when the trigger is met. Hold these seven until you leave the role.


== Daily Rituals -- The Index Card Version

**MORNING (15 min, before email)**

. Open notebook
. Review today's calendar -- circle the one meeting that matters
. Write the one decision you are avoiding
. Write 3 outcomes (not tasks -- outcomes have completion criteria)
. Set timer for deep work block
. Headphones on

**EVENING (15 min, same time every day)**

. Scan every task list -- nothing only in your head
. Check next 3 days -- flag anything needing prep
. Write tomorrow's 3 outcomes in notebook
...
_xref:14-operating-rhythm.adoc[Chapter 14] provides the evidence, the argument, and the practitioner frameworks behind every item on this page. This page provides the system. Use them together._
