...
:page-llms-description: The four stages of the startup CTO role — Coder, Manager, Director, Strategist — each demanding skills the previous stage never taught, with failure modes and transition guidance.
:page-haiku: Four jobs, one title. / Each asks you to surrender / what made you succeed.
:description: The startup CTO role is four different jobs in four years — coder, manager, director, strategist. Each stage demands skills the previous one never taught.
:keywords: CTO stages, coder manager director strategist, CTO career path, engineering leadership, startup growth
:page-date-published: 2026-03-09
:page-date-modified: 2026-03-11
:page-faq-1-q: What does a startup CTO actually do?
:page-faq-1-a: The startup CTO role is really four different jobs compressed into a few years — Coder, Manager, Director, and Strategist. In the earliest stage, you write most of the code. As the company grows, your job shifts to building teams, then leading leaders, and finally setting multi-year technology strategy. What kills most CTOs is not any single stage but the transitions between them.
:page-faq-2-q: How does the CTO role change as a startup grows?
:page-faq-2-a: At a startup with fewer than 15 people, the CTO spends 70% or more of their time coding. By the time the company reaches 45 employees, coding drops to under 10%. At 250-plus employees, the CTO writes no production code at all. Each stage demands entirely different skills — the technical excellence that made you successful early on must be gradually replaced by people management, strategic thinking, and business communication.
:page-faq-3-q: What are the four stages of a startup CTO?
...
xref:10-business-acumen-gap.adoc[Chapter 10] of this book examines the business acumen gap — the communication failures that Chalmers documented — in full. For now, the point is narrower. The stages are predictable. The transitions are predictable. The failure modes at each transition are predictable. What is not predictable is whether any given CTO will see the transition in time.
