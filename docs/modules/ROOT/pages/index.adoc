...
:page-llms-description: Overview of Applied Alchemy, a field guide for startup CTOs covering the transformation from coder to manager to director to strategist, with 17 chapters on technical decisions, team building, communication, AI, burnout, and leadership transitions.
:page-schema: book
...
* xref:1-four-stages-cto-evolution.adoc[Chapter 1: The Four Stages]
* xref:2-how-people-become-ctos.adoc[Chapter 2: How People Become CTOs]
* xref:3-ceo-cto-relationship.adoc[Chapter 3: The CEO-CTO Relationship]

=== Part II: Building and Shipping

* xref:4-technical-decisions-business-decisions.adoc[Chapter 4: Technical Decisions as Business Decisions]
* xref:5-technical-debt.adoc[Chapter 5: Technical Debt]
* xref:6-shipping-software.adoc[Chapter 6: Shipping]
* xref:7-rushing-vs-speed.adoc[Chapter 7: Rushing vs Speed]
* xref:8-working-with-product.adoc[Chapter 8: Working with Product]
* xref:9-measuring-engineering-metrics.adoc[Chapter 9: Measuring What Matters]

=== Part III: The Gap Nobody Talks About

* xref:10-business-acumen-gap.adoc[Chapter 10: The Business Acumen Gap]
* xref:11-building-engineering-team.adoc[Chapter 11: Building the Team]
* xref:12-ai-transformation.adoc[Chapter 12: AI Transformation]

=== Part IV: Surviving and Evolving

* xref:13-maker-to-multiplier.adoc[Chapter 13: From Maker to Multiplier]
* xref:14-operating-rhythm.adoc[Chapter 14: The Operating Rhythm]
* xref:15-cto-burnout-isolation.adoc[Chapter 15: Burnout and Isolation]
* xref:16-knowing-when-to-step-aside.adoc[Chapter 16: Knowing When to Step Aside]
* xref:17-building-lasting-legacy.adoc[Chapter 17: Building Something That Outlasts You]

=== Appendices

* xref:appendix-a-first-ninety-days.adoc[Appendix A: The First Ninety Days]
* xref:appendix-b-stage-metrics-guide.adoc[Appendix B: Stage-by-Stage Metrics Guide]
* xref:appendix-c-compensation-equity-benchmarks.adoc[Appendix C: Compensation and Equity Benchmarks]
* xref:appendix-d-technical-due-diligence.adoc[Appendix D: Technical Due Diligence Preparation Guide]
* xref:appendix-e-operating-rhythm-reference.adoc[Appendix E: The Operating Rhythm — Quick Reference]
* xref:appendix-f-recommended-reading.adoc[Appendix F: Recommended Reading]
* xref:appendix-g-ai-cto-advisor.adoc[Appendix G: Your AI CTO Advisor]
