...
Assess the hiring pipeline: shadow interviews, review the onboarding process, sit in on a closing call (Chapter 11). Identify the three most critical missing roles — Larson's constraint: "If every hire is a priority, nothing is a priority."footnote:larson90[]
