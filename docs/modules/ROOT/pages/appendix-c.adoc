...
The founding CTO drops below double-digit ownership at the seed round. By Series B, they hold roughly half their original percentage. The core paradox of startup equity: the percentage shrinks while the dollar value grows — _if_ the company succeeds. As Chapter 13 notes, 60% of venture-backed companies return less than the original investment (Cambridge Associates, 1990–2010).
...
_This appendix provides the numbers. Chapter 13 provides the argument for why the CTO must understand them — and the emotional reality of what happens when they do not._
